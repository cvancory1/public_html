...
// action='createAccount.php'
     echo" <div class='loginMain'>";
          ...
          echo"<form name='add_name' id='add_name'  method='post'  onsubmit='return checkForm(this);'>  
               ...
               <p id = 'errorPwd' style='display:none;'> Error: The password you have entered is not valid!  \nUse 8 or more charachters with at least 1 digit, 1 uppercase and 1 special charachters</p>
